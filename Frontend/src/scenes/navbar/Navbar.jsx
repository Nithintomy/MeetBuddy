...
function Navbar() {
  ...
  const fullName = user ? `${user.firstName} ${user.lastName}` : 'Nithin';


  return (
    <FlexBetween padding="1rem 6%" backgroundColor={alt}>
      <FlexBetween gap="1.75rem">
        <Typography onClick={() => navigate("/home")} sx={{ "&:hover": { color: primaryLight, cursor: "pointer" } }} fontWeight="bold" fontSize="clamp(1rem, 2rem, 2.25rem)">
          MeeTBuddY
        </Typography>
        {isNonMobileScreens && (
